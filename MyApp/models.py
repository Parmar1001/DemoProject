...
class Customer(models.Model):
    ...
    user_name=models.OneToOneField(User,related_name='customer',on_delete=models.CASCADE)
...
class Notification(models.Model):
    ...
    user_name=models.ForeignKey(User,related_name='notification',on_delete=models.CASCADE)
